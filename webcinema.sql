...
CREATE TABLE RESERVATION (
                             ...
                             CONSTRAINT fk_reservation_user FOREIGN KEY (ref_user) REFERENCES UTILISATEUR(id_utilisateur) ON DELETE CASCADE,
                             CONSTRAINT fk_reservation_seance FOREIGN KEY (ref_seance) REFERENCES SCEANCE(id_sceance) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
