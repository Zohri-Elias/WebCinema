...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li onclick="window.location.href='delete_film.html'">Supprimer un film</li>
    </ul>
</div>
...
<div class="content">
    ...
    <div class="form-container">
        <form action="../src/traitement/SupprimeFilmTrT.php" method="POST">
            <label for="id_film">ID du film à supprimer :</label>
